        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    <div class="col-md-4">Cursos</div>
                    <div class="col-md-4 offset-md-8">
                    <a class="btn btn-primary" href="{{route('curso.create')}}" role="button">Novo Curso</a>
                    </div>
                </div>
                <div class="card-header">
                    <div class="form-group">
                        <form action="{{route('curso.index')}}" method="GET" id="form_filtro_instituicao">
